...
description: "Les huit étapes, les trois monnaies, l'Âme, les Points de maîtrise, les ressources et un exemple monté de bout en bout."
---

Huit étapes, dans l'ordre. Les sept premières se décident, la dernière se calcule. Ne remplissez aucune case chiffrée avant l'étape 8 : un personnage se pose d'abord, il se compte ensuite.
...
Le MJ annonce toute modification de cet ensemble avant que la table commence. Une partie unique et une campagne longue n'ouvrent pas sur les mêmes chiffres.
...
PX
: Achètent les Arbres, les Compétences et leurs Niveaux. Un personnage n'a pas de niveau global : ses PX sont tout ce qui monte.
...
Le MJ accorde un point de Karma quand il le juge mérité et choisit l'emplacement. Un emplacement déjà rempli n'en reçoit pas de second. Le Karma conservé ne disparaît ni au repos ni en fin de séance.
...
Un point dépensé après le lancer ajoute ses dés à ce qui est déjà sur la table, puis les deux dés conservés sont déterminés de nouveau sur l'ensemble. C'est ce qui permet de sauver un Jet raté, et aussi d'en gâcher un réussi quand le point tombe sur un adversaire.

Certaines Compétences prennent le Karma comme ressource. Elles sont rares à l'usage pour cette raison.

### La Spécialité

La Spécialité est une Aptitude que vous inventez, au champ volontairement étroit : « Navigation », « Cuisine », « Monstres ». Elle monte avec des PM comme n'importe quelle Aptitude.

Quand elle s'applique, elle entre dans le Jet comme une Aptitude ordinaire et accorde en plus un Avantage. Un champ large donne un bonus tiède qui sert souvent ; un champ étroit donne un vrai coup de pouce qui sert rarement. Le MJ tranche les cas limites.

### Le Don

Le Don pose une capacité, une perception ou une particularité : « Je vois et je parle aux morts », « Mes dessins prennent vie », « Je sais quand on me ment ». Il ouvre une information, une permission ou une occasion qu'un autre personnage n'aurait pas.
...
Une Caractéristique coûte sa nouvelle valeur. Une Aptitude coûte la moitié de sa nouvelle valeur, arrondie au supérieur. Les deux coûtent au minimum 1.
...
Une Caractéristique sert partout où elle apparaît, une Aptitude seulement dans son domaine, et une Caractéristique coûte le double. La question n'est donc pas laquelle est la meilleure, mais combien de Jets différents vous voulez pouvoir tenter.
...
La fiche porte la liste complète, une case par Aptitude. Elles couvrent ce qu'un personnage sait faire, du pistage à la négociation.

Quatre d'entre elles sont aussi les quatre disciplines de fabrication : Artisanat, Arcanes, Technologie et Science. Il n'y a pas deux notions, il n'y en a qu'une. La discipline sous laquelle une pièce se travaille est l'Aptitude que vous jetez pour la fabriquer.
...
Achetez d'abord ce que vous jouerez à chaque combat. Une Compétence chère et située loin dans un Arbre attendra que la table vous l'ait payée.

## Les six valeurs à reporter

Ces six cases sont les seules qui se calculent. Reprenez-les après chaque achat de PM ou de PP.
...
Sélène, une éclaireuse. Ses 22 PM :
...
Ses 25 PX partent dans deux Compétences bon marché de son Arbre de Domaine. Six emplacements de Mémoire pour les deux Compétences qui en occupent, ses Compétences d'Espèce n'en prenant aucun : elle a de la place pour grandir avant d'avoir à choisir.

Sur un Jet de tir, elle lance `2d12 + 3 + 2`. Quand elle piste, sa Spécialité entre dans le Jet et lui donne un Avantage par-dessus.
