...
| `languages` | optional | Langue(s) que l'Espèce parle, lit et écrit. Absent : l'Espèce n'en déclare pas encore, ou elle les tient de l'une de ses Espèces parentes. | keys from `data/meta/languages.json` |
