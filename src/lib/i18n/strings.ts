...
const fr = {
  ...
  ruleWords: 'Mots de règle',
  ruleWordsUsed: 'Les mots de règle que les Compétences de cet arbre emploient',
  ruleWordsFromEquipment: 'Les mots de règle que ce catalogue emploie',
  rulesAtBack: 'Mots de règle et états : définis en fin de livret',
  contents: 'Sommaire',
  sets_: 'Panoplies',
  setPieces: 'pièces',
...
const en: UiStrings = {
  ...
  ruleWords: 'Rule words',
  ruleWordsUsed: 'The rule words the skills on this plate use',
  ruleWordsFromEquipment: 'The rule words this catalogue uses',
  rulesAtBack: 'Rule words and states: defined at the back',
  contents: 'Contents',
  sets_: 'Sets',
  setPieces: 'pieces',
